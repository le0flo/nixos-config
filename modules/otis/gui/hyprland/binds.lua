...
hl.bind("Print", hl.dsp.exec_cmd("slurp -w 2 | grim -c -g - ~/Pictures/Screenshots/screenshot-$(date +%Y-%m-%d-%H%M%S).png"))
hl.bind("CTRL + Print", hl.dsp.exec_cmd("grim -c ~/Pictures/Screenshots/screenshot-$(date +%Y-%m-%d-%H%M%S).png"))
