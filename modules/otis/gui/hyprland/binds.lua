...
hl.bind("Print", hl.dsp.exec_cmd("slurp -w 2 | grim -c -g - - | tee ~/Pictures/Screenshots/screenshot-$(date +%Y-%m-%d-%H%M%S).png | wl-copy -t image/png && notify-send 'Screenshot saved'"))
hl.bind("CTRL + Print", hl.dsp.exec_cmd("grim -c - | tee ~/Pictures/Screenshots/screenshot-$(date +%Y-%m-%d-%H%M%S).png | wl-copy -t image/png && notify-send 'Screenshot saved'"))
